...
//                        )
//                        1 -> WalletScreen(viewModel, onMenuClick = { scope.launch { drawerState.open() } })
//                        2 -> ReportScreen(onMenuClick = { scope.launch { drawerState.open() } })
//                        3 -> HistoryScreen(viewModel, onMenuClick = { scope.launch { drawerState.open() } })
//                    }
//                }
//            }
//        }
...
//import com.example.modernui.ui.screens.CashDepositScreen
